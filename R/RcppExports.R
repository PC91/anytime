...
anytime_cpp <- function(x, fmts, tz = "UTC", asUTC = FALSE, asDate = FALSE, useR = FALSE, oldHeuristic = FALSE) {
    .Call(`_anytime_anytime_cpp`, x, fmts, tz, asUTC, asDate, useR, oldHeuristic)
}
